...
func (s *periodicSuite) Test_SkipsWhenAllStepsFail() {
	...
	env.OnWorkflow(workflow.RefactorStepWorkflow, mock.Anything, mock.Anything).
		Return(workflow.RefactorStepResult{Kind: workflow.StepCircuitBroken}, testErr("implement produced no changes"))
...
func (s *periodicSuite) Test_HappyPath_AutoMergeDisabled() {
	...
	env.OnWorkflow(workflow.RefactorStepWorkflow, mock.Anything, mock.Anything).
		Return(workflow.RefactorStepResult{Kind: workflow.StepCompleted, CommitSHA: "sha1"}, nil)
...
func (s *periodicSuite) Test_StepsCapAtMaxStepsPerRun() {
	...
	env.OnWorkflow(workflow.RefactorStepWorkflow, mock.Anything, mock.Anything).
		Return(workflow.RefactorStepResult{Kind: workflow.StepCompleted, CommitSHA: "sha"}, nil)
