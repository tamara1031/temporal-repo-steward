...
func (s *designPhaseSuite) Test_CriticalBlock_Skips() {
	...
	env.OnActivity(acts.ReviewActivity, mock.Anything, mock.Anything).
		Return(codexact.ReviewResult{Verdict: codexact.ReviewVerdictCriticalBlock, Feedback: "this is dangerous"}, nil)
...
func (s *designPhaseSuite) Test_RefinesOnSuggest_UpdatesPlan() {
	...
	env.OnActivity(acts.ReviewActivity, mock.Anything, mock.Anything).
		Return(codexact.ReviewResult{Verdict: codexact.ReviewVerdictSuggest, Feedback: "improve x"}, nil).Once()
	...
	env.OnActivity(acts.ReviewActivity, mock.Anything, mock.Anything).
		Return(codexact.ReviewResult{Verdict: codexact.ReviewVerdictOK}, nil).Once()
